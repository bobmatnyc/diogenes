...
/**
 * Quick test script for the comprehensive memory system
 * Run with: npx tsx test-memory-quick.ts
 */

import { MemoryService } from './src/lib/kuzu/service';
import { LocalStorageAdapter } from './src/lib/kuzu/storage/local-adapter';
